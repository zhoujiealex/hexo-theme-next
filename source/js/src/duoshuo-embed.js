...
function sskadmin(e) {
    var ssk = '';
    if (e.user_id == 6284895680469140000) {
        if (checkMobile()) {
            ssk = '<span class="ua"><span class="sskadmin">Root</span></span><br><br>';
        } else {
            ssk = '<span class="ua"><span class="sskadmin">Root</span></span>';
        }
    } else {
        if (checkMobile()) {
            ssk = '<br><br>';
